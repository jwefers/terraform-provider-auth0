...
import (
	...
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/eventstream"
	userattributeprofile "github.com/auth0/terraform-provider-auth0/pkg/auth0/user_attribute_profile"
	"github.com/auth0/terraform-provider-auth0/pkg/config"

	"github.com/auth0/terraform-provider-auth0/pkg/auth0/networkacl"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/outboundips"

	"github.com/auth0/terraform-provider-auth0/pkg/auth0/tokenexchangeprofile"

	"github.com/auth0/terraform-provider-auth0/pkg/auth0/flow"

	"github.com/auth0/terraform-provider-auth0/pkg/auth0/form"

	"github.com/auth0/terraform-provider-auth0/pkg/auth0/selfserviceprofile"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/supplementalsignals"

	"github.com/hashicorp/terraform-plugin-sdk/v2/helper/schema"

	"github.com/auth0/terraform-provider-auth0/pkg/auth0/action"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/attackprotection"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/branding"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/client"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/connection"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/customdomain"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/email"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/encryptionkeymanager"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/guardian"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/hook"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/logstream"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/organization"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/page"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/prompt"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/resourceserver"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/riskassessment"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/role"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/rule"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/signingkey"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/tenant"
	"github.com/auth0/terraform-provider-auth0/pkg/auth0/user"
)
...
func New() *schema.Provider {
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"auth0_connection_directory_synchronized_groups": connection.NewDirectorySynchronizedGroupsResource(),
			...
			"auth0_custom_domain_default":                    customdomain.NewDefaultResource(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"auth0_connection_directory_synchronized_groups": connection.NewDirectorySynchronizedGroupsDataSource(),
